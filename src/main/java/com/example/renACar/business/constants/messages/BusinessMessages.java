package com.example.renACar.business.constants.messages;
...
public class BusinessMessages {
    ...
    public class CarMaintenanceMessages{
        ...
        public static final String CAR_ID_EXISTS_IN_RENTAL="Car Is Rent Now Car_id : " ;
    }
    ...
    public class CarMessages{
        ...
        public static final String CAR_LISTED_NUMBER_FALSE ="Enter 1 to sort from smallest to largest. Enter 2 to sort from largest to smallest. ";
    }
